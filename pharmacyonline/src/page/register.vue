...
<section>
  <div class="main">
<div class="jua">
  <p><span class="left_tu"><img src="../img/bar_gift.png" alt=""></span>注册并绑定手机号码可获<em>3澳无门槛 </em>优惠券</p>
  </div>
  <van-cell-group>
  ...
  >
    ...
    type="password"
      left-icon="coupon-o"
    label="密码"
    placeholder="密码（6-20位字母或数字组合）" 
  />

  <p><input type="checkbox" name="" id=""><span>已阅读并同意</span><a href="">《服务条例》</a>及<a  href="">《隐私条款》</a></p>
