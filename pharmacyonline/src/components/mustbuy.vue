...
export default {
  ...
  created() {
    this.$tunhuoji.get("/nodegoodslist/a", {}).then(res => {
      ...
      this.goodslist2 = data.goods_info.slice(13, 15);
      this.goodslist3 = data.goods_info.slice(15, 17);
      this.goodslist4 = data.goods_info.slice(20, 22);
